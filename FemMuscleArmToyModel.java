...
public class FemMuscleArmToyModel extends MuscleArm
{
    RigidBody upperArm;
    RigidBody lowerArm;
    RigidBody box;
    ...
    public static PropertyList myProps = new PropertyList (
       FemMuscleArmToyModel.class, MuscleArm.class);
...
//        addLoad();
   ...
   public void addBox()   
      throws IOException 
   {
      box = RigidBody.createBox(" box ", /* wx ,wy , wz =*/ 2 , 2 , 2 , /* density = */ 20) ;
      if (box==null)
      {
          return;
      }
      ...
      box.setPose(new RigidTransform3d(/*x ,y ,z= */ -6.0 , 0, 0) );
      // create marker point and connect it to the box :
      model.addRigidBody(box);
        ...
        throws IOException 
    {
        ...
        lowerArm = model.rigidBodies().get("lower");
...
//        Point3d upper = new Point3d(2.4, 0, 20), lower = new Point3d(3, 0, -7);
    ...
    public void setCollisions(boolean collisions)
    {
       ...
       RigidBody lowerArm = 
          (RigidBody)mech.findComponent ("rigidBodies/lower");
       RigidBody box = 
          (RigidBody)mech.findComponent ("rigidBodies/box");

       if (collisions)
       {
          mech.setCollisionBehavior (muscle, upperArm, true);
          mech.setCollisionBehavior (box, lowerArm, true);
       }
       else
       {
          mech.setCollisionBehavior (muscle, upperArm, false);
          mech.setCollisionBehavior (box, lowerArm, false);
       }
    }
